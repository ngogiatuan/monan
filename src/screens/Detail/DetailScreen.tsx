...
const DetailScreen = () => {
    ...
    if (!recipeId) {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Text>Không tìm thấy mã công thức (recipeId).</Text>
            </View>
        );
    }
    ...
    useEffect(() => {
        const subscription = DeviceEventEmitter.addListener('reviewCountUpdated', ({ recipeId, increment }) => {
        });
        ...
        <View style={{ flex: 1, backgroundColor: '#F6F6F6' }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: '#F6F6F6' }}>
                ...
                <View style={styles.infoSection}>
                    ...
                    <Text style={styles.desc}>{String(recipe.description || '')}</Text>
                ...
                <View style={styles.ingredientSection}>
                    ...
                    <View style={styles.ingredientList}>
                        <Text style={styles.ingredientItem}>{String(recipe?.instructions || '')}</Text>
                    </View>
                </View>
                ...
                <View style={styles.relatedSection}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate(nav.discovery)}>
                            <Text style={styles.seeMoreReview}>{t('see_more')}</Text>
                        </TouchableOpacity>
                    </View>
                    <FlatList
                            ...
                            return (
                                <View style={styles.relatedCard}>
                                    ...
                                    >
                                        ...
                                        <Text style={styles.relatedName} numberOfLines={2}>{String(item.name || '')}</Text>
                                        <View style={styles.relatedInfoRow}>
                                            <View style={styles.ratingBox}>
                                                <Text style={styles.ratingText}>
                                                    ★ {String(relatedRatings[item._id || item.id]?.avg?.toFixed(1) ?? '0.0')}
                                                </Text>
                                            </View>
                                            <Text
                                                style={{
                                            ...
                                            >
                                                {String(relatedRatings[item._id || item.id]?.count ?? 0)} Reviews
                                            </Text>
